...
## [1.187.0](https://github.com/OSNewbie/metacubexd/compare/v1.186.1...v1.187.0) (2025-04-07)


### Features

* add changelog component and update version handling ([bf7c535](https://github.com/OSNewbie/metacubexd/commit/bf7c53550e5e305f104b92d542b3755c33da8c4f))
* add custom font theme variables for Twemoji and system fonts ([af8b3e2](https://github.com/OSNewbie/metacubexd/commit/af8b3e2f7003e9831aa3c8a941f5bd5bb8fefc41))
* bump version ([64a2005](https://github.com/OSNewbie/metacubexd/commit/64a20050d9f07943a6671002fe7c8cc22092fe5f))
* config for icon height and margin-right ([#1041](https://github.com/OSNewbie/metacubexd/issues/1041)) ([bf26a53](https://github.com/OSNewbie/metacubexd/commit/bf26a539bce4a995bf254f1653d98c3b5f1c0a22))
* **config:** check for frontend version update ([657c180](https://github.com/OSNewbie/metacubexd/commit/657c180e056e345776ac1a21966c4c3eafdb1d09))
* **config:** clear dns query results when input content gets cleared ([04cae65](https://github.com/OSNewbie/metacubexd/commit/04cae65805fac8102246f57aa438fc054bc68174))
* **config:** rearrange settings ([90c3d15](https://github.com/OSNewbie/metacubexd/commit/90c3d15616860c27c80b47e4190414a68ec395c2))
* **config:** refresh backend version after core gets updated ([73b7e3e](https://github.com/OSNewbie/metacubexd/commit/73b7e3e40a4a8ad18f5fece8260217ddb4bcfddb))
* **connections:** add isClosingConnections spinner ([23193c5](https://github.com/OSNewbie/metacubexd/commit/23193c5c98e41cc73250c4567f2558ee6f8943fb))
* **connections:** enable autoCloseConns by default ([dfcc750](https://github.com/OSNewbie/metacubexd/commit/dfcc750a1231d2614b5db92619bd71b89661cacc))
* **connections:** reduce default visible columns ([ca9e3ba](https://github.com/OSNewbie/metacubexd/commit/ca9e3ba57e4849c7349c8ff4fab018989b057d10))
* custom table columns order for mobile ([#885](https://github.com/OSNewbie/metacubexd/issues/885)) ([3fd6abb](https://github.com/OSNewbie/metacubexd/commit/3fd6abb879b6aa4d3fa42b40210f39c2160d00c7))
* dual column for proxies render ([#1152](https://github.com/OSNewbie/metacubexd/issues/1152)) ([96869c9](https://github.com/OSNewbie/metacubexd/commit/96869c96c6291456b0720a5248f2cf7fe5630c48))
* embed fira sans web font ([b3ed3b5](https://github.com/OSNewbie/metacubexd/commit/b3ed3b50a5a074a7a30b754c8fa235bb63ca09cc))
* enhance ProxyNodeCard badge opacity and font weight ([3fdf74d](https://github.com/OSNewbie/metacubexd/commit/3fdf74d57a6259237ad482b1c4b5ca85a9762ac1)), closes [#1361](https://github.com/OSNewbie/metacubexd/issues/1361)
* hidden api & remove domain unmaintained ([#939](https://github.com/OSNewbie/metacubexd/issues/939)) ([bd65478](https://github.com/OSNewbie/metacubexd/commit/bd6547873fcc64a500eadda78a1607be59e11a97))
* **i18n:** added support for Russian language ([#1234](https://github.com/OSNewbie/metacubexd/issues/1234)) ([5e033d9](https://github.com/OSNewbie/metacubexd/commit/5e033d9f76c95ba7e3d9e7528a43f783736858fa))
* **latency:** enhance loading state with proxy latency updates ([69015f1](https://github.com/OSNewbie/metacubexd/commit/69015f1187fc63fc28a550569eb9f3746a4d846c))
* make persisted for ipv6 result ([#983](https://github.com/OSNewbie/metacubexd/issues/983)) ([2078051](https://github.com/OSNewbie/metacubexd/commit/2078051d7c8433ceda4240d41952cff32308990c))
* modes list for sing-box offical ([#1182](https://github.com/OSNewbie/metacubexd/issues/1182)) ([1ca89fb](https://github.com/OSNewbie/metacubexd/commit/1ca89fb6c736bcdb4d4b84552828fc7df3fa131d))
* optimize setup form ([#960](https://github.com/OSNewbie/metacubexd/issues/960)) ([00ab6d4](https://github.com/OSNewbie/metacubexd/commit/00ab6d46458c20d41b8b8080a8f57736d600d8d0))
* preview dlspeed in proxies page ([#924](https://github.com/OSNewbie/metacubexd/issues/924)) ([51a88b5](https://github.com/OSNewbie/metacubexd/commit/51a88b506c1c4a5c41ff9a5c0e12a630f82a79fe))
* **proxies:** add multi-column render back ([9f7f8d0](https://github.com/OSNewbie/metacubexd/commit/9f7f8d0161103c222747b4d65f330057edd87d81))
* **proxies:** add proxy latency test history timeline ([1e7dcb1](https://github.com/OSNewbie/metacubexd/commit/1e7dcb13bc212c1b2e717bbaa72e9583edce41f4))
* **proxies:** add render in two columns option back ([1fd22d3](https://github.com/OSNewbie/metacubexd/commit/1fd22d3ece0905f1f22acb94d7d6a7a86a7a31e9))
* **proxies:** add subtle padding between title and footer ([e7ef8b3](https://github.com/OSNewbie/metacubexd/commit/e7ef8b373587c791283e6aaf8c11c3d0bb19367b))
* **proxies:** adjust collapsible grid columns ([3d1a234](https://github.com/OSNewbie/metacubexd/commit/3d1a2349780f780976192ed8cc06ada6b46c069b))
* **proxies:** display specialTypes on mobile in title ([0973686](https://github.com/OSNewbie/metacubexd/commit/09736863dfb7ca8738e70a0460ea401630182dab))
* **proxies:** drop ipv6 latency test & display ([cdd60cf](https://github.com/OSNewbie/metacubexd/commit/cdd60cfc37999da0f04bb7d286d8edd55f841dcb))
* **proxies:** gradient gradient gradient ([ca13549](https://github.com/OSNewbie/metacubexd/commit/ca1354943450bc927b508df9fac935047cb30d42))
* **proxies:** mount tooltip portal within rootElement ([554b361](https://github.com/OSNewbie/metacubexd/commit/554b3611844f355347ee99466c879fba035610cc))
* **proxies:** overhaul the look of proxies page, drop renderInTwoColumns support ([698362f](https://github.com/OSNewbie/metacubexd/commit/698362f1c7b31837ac60bdfde7aac1deccb2ea35))
* **proxies:** replace gradient with pure background color ([e273439](https://github.com/OSNewbie/metacubexd/commit/e273439f688790f5ced9f0fac9f2ac5d7064650e))
* **proxies:** restructure layout of ProxyNode display for improved readability ([9c0da7a](https://github.com/OSNewbie/metacubexd/commit/9c0da7a3897723d4de9d05867cf2d07a81481115))
* **proxies:** show latency result only when possible ([4314e64](https://github.com/OSNewbie/metacubexd/commit/4314e64785a2caa5f1dbdb2896f2b28af8716f41))
* **proxies:** update layout, disable twemoji font by default ([3d8fa08](https://github.com/OSNewbie/metacubexd/commit/3d8fa080c351fa155c8c0edc7e4f6fee06438693))
* proxy group icon ([#1023](https://github.com/OSNewbie/metacubexd/issues/1023)) ([0b1d472](https://github.com/OSNewbie/metacubexd/commit/0b1d472d62734cba0bb75efa6acc787957b571c6))
* proxy type support i18n ([#1135](https://github.com/OSNewbie/metacubexd/issues/1135)) ([b0f32b5](https://github.com/OSNewbie/metacubexd/commit/b0f32b5e5583ca673ade44bbbe058900b4630a74))
* **proxy-node:** add UDP indicator and improve special types display ([cae651f](https://github.com/OSNewbie/metacubexd/commit/cae651fa1cb15a0d620503741039b7a9f49f486b))
* **proxy-node:** update ProxyNodeCard styling and structure for improved layout and clarity ([8c5d184](https://github.com/OSNewbie/metacubexd/commit/8c5d1845a7f5e780014f2f8288f6e5602687225a))
* reconnect ws when logs level changed ([#1003](https://github.com/OSNewbie/metacubexd/issues/1003)) ([246a1ac](https://github.com/OSNewbie/metacubexd/commit/246a1ac053ef56a1930d3ad2ae3bd0784e01c513))
* **rules:** search input align with tabs ([ab018c5](https://github.com/OSNewbie/metacubexd/commit/ab018c529dea2f5af14cdd8b6724c01cecbbf59c))
* set default DNS query target same as the placeholder ([#1346](https://github.com/OSNewbie/metacubexd/issues/1346)) ([9874c74](https://github.com/OSNewbie/metacubexd/commit/9874c7429a01cf0701a8894bc15c22d97bebb549))
* show current page title, closes [#474](https://github.com/OSNewbie/metacubexd/issues/474) ([9c76d7f](https://github.com/OSNewbie/metacubexd/commit/9c76d7ff76886495208809d3e0f2efc6e90de2f3))
* Support dynamic acquisition of clash_mode ([#908](https://github.com/OSNewbie/metacubexd/issues/908)) ([341a14a](https://github.com/OSNewbie/metacubexd/commit/341a14a7bcdf6054fb3bb8f1d6bb87e78cc38db7))
* support to set icon color to the theme color when proxy icon starts with `data:image/svg+xml` ([#1166](https://github.com/OSNewbie/metacubexd/issues/1166)) ([29ed55c](https://github.com/OSNewbie/metacubexd/commit/29ed55cf50298578a9fa92a209a1c9f70882ea43))
* trigger release ([62a89d4](https://github.com/OSNewbie/metacubexd/commit/62a89d4ee3d8b0b9c98a6eebbf51f5fe8c362879))
* trigger release ([c761086](https://github.com/OSNewbie/metacubexd/commit/c7610860d54ce7984ca290311c0b1ae5cb668256))
* trigger release ([2df7158](https://github.com/OSNewbie/metacubexd/commit/2df7158f8a1a5b3e81e0ffd68eb1918582002d62))
* update ProxyNodeCard badge styling ([e44e190](https://github.com/OSNewbie/metacubexd/commit/e44e190aaf77d6247289285600b04860ed7d72b3))
* **versions:** enable force update by default, closes [#1376](https://github.com/OSNewbie/metacubexd/issues/1376) ([fd11412](https://github.com/OSNewbie/metacubexd/commit/fd114127d62556278825d6837585c49ef6e07f80))
* **versions:** update Tooltip.Trigger classes for better styling consistency ([9ad414c](https://github.com/OSNewbie/metacubexd/commit/9ad414c46baf5755aa26bbe36000b61266945879))


### Bug Fixes

* bg color ([#1355](https://github.com/OSNewbie/metacubexd/issues/1355)) ([6c84d16](https://github.com/OSNewbie/metacubexd/commit/6c84d16966ae265b4410b7117dab867062da5ffa))
* **config:** missing translation for running mode ([705f651](https://github.com/OSNewbie/metacubexd/commit/705f6513469466ac74c137f396c135b31da31804))
* **config:** mode select options are missing ([21a3aa1](https://github.com/OSNewbie/metacubexd/commit/21a3aa169ed3fe53f04a97c806ef20a11120fdea))
* **config:** options are not getting reflected in fav light/dark theme select, closes [#1079](https://github.com/OSNewbie/metacubexd/issues/1079) ([ae1158d](https://github.com/OSNewbie/metacubexd/commit/ae1158d9577f3e4c9bf6efe5fb2737065559f777))
* **config:** selected option ([d6ce137](https://github.com/OSNewbie/metacubexd/commit/d6ce1376a67bdd8b439730505563084cb1ba082e))
* **Connections:** SourceIP filter and tagging ([#1286](https://github.com/OSNewbie/metacubexd/issues/1286)) ([a1c9d2f](https://github.com/OSNewbie/metacubexd/commit/a1c9d2f03282f976ee20a78ecf405de5952c1207))
* filter for loadbalance ([#881](https://github.com/OSNewbie/metacubexd/issues/881)) ([faf7a7e](https://github.com/OSNewbie/metacubexd/commit/faf7a7ebd04872b47ec62e87aac3bff406268d5b))
* Fix the available update indicator causing horizontal overflow on mobile. ([#1153](https://github.com/OSNewbie/metacubexd/issues/1153)) ([ff41847](https://github.com/OSNewbie/metacubexd/commit/ff41847fd933e64e30c6f7b501e720e0d2fc5158))
* fixed latency color ([#1251](https://github.com/OSNewbie/metacubexd/issues/1251)) ([1a66ee6](https://github.com/OSNewbie/metacubexd/commit/1a66ee684789b2cee8a69f9229e9d2f3f002af78))
* flickering issue of the config page under sing-box ([#900](https://github.com/OSNewbie/metacubexd/issues/900)) ([b07647c](https://github.com/OSNewbie/metacubexd/commit/b07647c549a26868af6c27cc6e8c25501c80b3b3))
* I18n unable to get value for name ([#1206](https://github.com/OSNewbie/metacubexd/issues/1206)) ([92a2e39](https://github.com/OSNewbie/metacubexd/commit/92a2e3985d3596b9048dd49fd69987fcadf0e515))
* **i18n:** time locale not working ([e6fa749](https://github.com/OSNewbie/metacubexd/commit/e6fa749a28e55b9ea85a5ccae71346823fd2567c))
* improve readability for dlspeed preview ([#932](https://github.com/OSNewbie/metacubexd/issues/932)) ([3727122](https://github.com/OSNewbie/metacubexd/commit/3727122b95cde32ef15d7383fa8d9eee98dfd5f0))
* latency not correct when proxy group has custom test url ([#1199](https://github.com/OSNewbie/metacubexd/issues/1199)) ([23e56cf](https://github.com/OSNewbie/metacubexd/commit/23e56cfde81fcd0453106e477cdf9e17f98019ae))
* latency not correct when set custom url in config ([#1189](https://github.com/OSNewbie/metacubexd/issues/1189)) ([af30813](https://github.com/OSNewbie/metacubexd/commit/af3081371d3c6fb7a748b8c9a11cb5dcd5b31dca))
* nil for nextnode ([#892](https://github.com/OSNewbie/metacubexd/issues/892)) ([a4be392](https://github.com/OSNewbie/metacubexd/commit/a4be39268a496055b76e0679fe1b2e060ee6c2a7))
* **overview:** traffic widget, truncate the texts to fix overflow ([dc9db7c](https://github.com/OSNewbie/metacubexd/commit/dc9db7c60c5db056418a9af6e2d09184cf482a82))
* **overview:** update stats component background and change chart type for better visual clarity ([dc1df6c](https://github.com/OSNewbie/metacubexd/commit/dc1df6c382346e90d3657dfc1e953a5caa40aa41))
* **proxies:** double specialType if statement ([0c004be](https://github.com/OSNewbie/metacubexd/commit/0c004be98f062f79806a4ef95949f380d17571e1))
* **proxies:** prevent proxyName from overflowing ([4037597](https://github.com/OSNewbie/metacubexd/commit/40375979b8d1328ba3dde5e0a61d24271dfd4b3e))
* **proxies:** proxy type should be positioned relative to the card ([78ec9e5](https://github.com/OSNewbie/metacubexd/commit/78ec9e5d6c574e85405f7138782f39cce3a8a345))
* **proxies:** set break all on proxy name ([a31d2e8](https://github.com/OSNewbie/metacubexd/commit/a31d2e8d148c81f93b82d6bce55b0fff7410f61d))
* proxy group ipv6 test failed ([#996](https://github.com/OSNewbie/metacubexd/issues/996)) ([c43b84b](https://github.com/OSNewbie/metacubexd/commit/c43b84b1149939bf604e6798931f221fa191bc6b))
* **pwa:** items in includeAssets cannot be empty string ([ab794e7](https://github.com/OSNewbie/metacubexd/commit/ab794e73e3fce6de51485aa1837344117941fc9f))
* release failure caused by `pnpm-lock.yaml is not up to date` ([5e4b132](https://github.com/OSNewbie/metacubexd/commit/5e4b1326bd7987a66ebd45bab1decbb02da19485))
* **rules:** fix rules search ([#1267](https://github.com/OSNewbie/metacubexd/issues/1267)) ([#1272](https://github.com/OSNewbie/metacubexd/issues/1272)) ([30f9bb4](https://github.com/OSNewbie/metacubexd/commit/30f9bb4854c9318c135468502ce1bc0586bdee81))
* **rules:** restore name display ([cdef0e8](https://github.com/OSNewbie/metacubexd/commit/cdef0e8355fe0c25ee35d1345d54fda050f1fece))
* **rules:** text spacing of `updated at` ([342119e](https://github.com/OSNewbie/metacubexd/commit/342119e01e5a4fe02ca6cb68902d08d52f36c486))
* set latency for test failed ([#948](https://github.com/OSNewbie/metacubexd/issues/948)) ([9189bf5](https://github.com/OSNewbie/metacubexd/commit/9189bf5efb0676a053981e0ffd3b3c21f8332dcf))
* table tr keyed ([#1261](https://github.com/OSNewbie/metacubexd/issues/1261)) ([cd27359](https://github.com/OSNewbie/metacubexd/commit/cd273598a9fc7b25f023621e2cfc99b41353262d))
* the health check for the proxy provider sometimes do not respond ([#1255](https://github.com/OSNewbie/metacubexd/issues/1255)) ([96bc233](https://github.com/OSNewbie/metacubexd/commit/96bc233f89003072d066332ce7b0c97adb107064))
* unexpected filtered proxy group ([#875](https://github.com/OSNewbie/metacubexd/issues/875)) ([9289353](https://github.com/OSNewbie/metacubexd/commit/928935321bfd9fea4b184423df344354392cfb51))
* use google as default ipv6 test url ([#894](https://github.com/OSNewbie/metacubexd/issues/894)) ([dba6d1a](https://github.com/OSNewbie/metacubexd/commit/dba6d1a4a953dba0bbaec18a45e9e74bc82d72f9))
* **versions:** disable update when none available or during update process ([e050d07](https://github.com/OSNewbie/metacubexd/commit/e050d07de4fac94a6c695f660f9edeb7fc043a3c))
* **versions:** prevent update trigger during ongoing update process ([ed55418](https://github.com/OSNewbie/metacubexd/commit/ed554188bd75eb86baf2e6f22c5d4c66097946f7))
* **versions:** reload page after successful update for frontend and backend ([edf0d47](https://github.com/OSNewbie/metacubexd/commit/edf0d47eb55f34df4dfe2979f28a5d1c1b421e4c))
